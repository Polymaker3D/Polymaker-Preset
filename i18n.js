...
var I18N = (function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      // X2D progress
      'x2d.kicker': 'Support Status',
      'x2d.meta.loading': 'Loading support status...',
      'x2d.meta.error': 'Unable to load support status right now.',
      'x2d.score.label': 'Coverage',
      'x2d.metric.completed': 'Supported',
      'x2d.metric.remaining': 'Incompatible',
      'x2d.metric.deadline': 'Total Materials',
      'x2d.metric.timeline': 'Coverage',
      'x2d.title.fallback': 'Bambu X2D Preset Support Status',
      'x2d.goal.fallback': 'X2D presets are available for all compatible materials',
      'x2d.goal.with.date': '{goal} before {date}.',
      'x2d.goal.without.date': '{goal}.',
      'x2d.scope': 'View product checklist ({n})',
      'x2d.scope.initial': 'View product checklist (0)',
      'x2d.status.incompatible': 'Incompatible',
      'x2d.status.done': 'Done',
      'x2d.status.pending': 'Pending',
      'x2d.value.unknown.product': 'Unknown product',
      'x2d.date.notset': 'Date not set',
      'x2d.date.today': 'Due today',
      'x2d.date.one.day.left': '1 day left',
      'x2d.date.days.left': '{n} days left',
      'x2d.date.one.day.overdue': '1 day overdue',
      'x2d.date.days.overdue': '{n} days overdue',
      'x2d.date.unavailable': 'Unavailable',
      'x2d.month.1': 'January',
      'x2d.month.2': 'February',
      'x2d.month.3': 'March',
      'x2d.month.4': 'April',
      'x2d.month.5': 'May',
      'x2d.month.6': 'June',
      'x2d.month.7': 'July',
      'x2d.month.8': 'August',
      'x2d.month.9': 'September',
      'x2d.month.10': 'October',
      'x2d.month.11': 'November',
      'x2d.month.12': 'December',
    ...
    zh: {
      ...
      // X2D progress
      'x2d.kicker': '支持状态',
      'x2d.meta.loading': '正在加载支持状态...',
      'x2d.meta.error': '暂时无法加载支持状态。',
      'x2d.score.label': '覆盖率',
      'x2d.metric.completed': '已支持',
      'x2d.metric.remaining': '不兼容',
      'x2d.metric.deadline': '材料总数',
      'x2d.metric.timeline': '覆盖率',
      'x2d.title.fallback': 'Bambu X2D 预设支持状态',
      'x2d.goal.fallback': '所有兼容材料均已提供 X2D 预设',
      'x2d.goal.with.date': '{goal}，预计在 {date} 前完成。',
      'x2d.goal.without.date': '{goal}。',
      'x2d.scope': '查看产品清单（{n}）',
      'x2d.scope.initial': '查看产品清单（0）',
      'x2d.status.incompatible': '不兼容',
      'x2d.status.done': '已完成',
      'x2d.status.pending': '待完成',
      'x2d.value.unknown.product': '未知产品',
      'x2d.date.notset': '未设置日期',
      'x2d.date.today': '今天到期',
      'x2d.date.one.day.left': '还剩 1 天',
      'x2d.date.days.left': '还剩 {n} 天',
      'x2d.date.one.day.overdue': '已逾期 1 天',
      'x2d.date.days.overdue': '已逾期 {n} 天',
      'x2d.date.unavailable': '暂不可用',
      'x2d.month.1': '1月',
      'x2d.month.2': '2月',
      'x2d.month.3': '3月',
      'x2d.month.4': '4月',
